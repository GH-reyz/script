...
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
echo -e "  \e[$text Traffic\e[m           \e[$below Today          Yesterday          Month" 
echo -e "  \e[$text Upload\e[m            \e[$white $today_tx $today_txv      $yesterday_tx $yesterday_txv         $month_tx $month_txv"
echo -e "  \e[$text Download\e[m          \e[$white $today_rx $today_rxv      $yesterday_rx $yesterday_rxv         $month_rx $month_rxv"
...
echo -e   "                               \e[$white $total_ssh               $total_xray                $total_v2ray"
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
