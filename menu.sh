...
echo -e "  \e[$line═════════════════════════════════════════════════════════════════\e[m"
echo -e "  \e[$back Traffic\e[m           Today          Yesterday          Month" 
echo -e "  \e[$back Upload\e[m            $today_tx $today_txv      $yesterday_tx $yesterday_txv         $month_tx $month_txv"
echo -e "  \e[$back Download\e[m          $today_rx $today_rxv      $yesterday_rx $yesterday_rxv         $month_rx $month_rxv"
echo -e "  \e[$back Total\e[m             $today $today_v      $yesterday $yesterday_v         $month $month_v"
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
