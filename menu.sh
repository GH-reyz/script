...
echo -e "  \e[$line═════════════════════════════════════════════════════════════════\e[m"
echo -e "  \e[$back Traffic           Today          Yesterday          Month" 
echo -e "  \e[$back Upload            $today_tx $today_txv      $yesterday_tx $yesterday_txv         $month_tx $month_txv"
echo -e "  \e[$back Download          $today_rx $today_rxv      $yesterday_rx $yesterday_rxv         $month_rx $month_rxv"
echo -e "  \e[$back Total             $today $today_v      $yesterday $yesterday_v         $month $month_v"
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
echo -e "  \e[$back Total User\e[m        \e[${back}Ssh/Ovpn          Xray            V2ray" 
echo -e   "\e[$back                        $total_ssh               $total_xray                $total_v2ray"
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
