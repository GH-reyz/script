...
echo -e  " ${red}═════════════════════════════════════════════════════════════════ "
echo -e  " ${purple}VPS TYPE                    : PREMIUM"
echo -e  " ${purple}IP VPS NUMBER               : $IPVPS${NC}"
echo -e  " ${purple}DOMAIN                      : $DOMAIN${NC}"
echo -e  " ${purple}SCRIPT VERSION              : REYZ-V4 (V1)"
echo -e  " ${purple}OS VERSION                  : `hostnamectl | grep "Operating System" | cut -d ' ' -f5-`"${NC}
echo -e  " ${purple}KERNEL VERSION              : `uname -r`${NC}"
echo -e  " ${purple}EXP DATE CERT V2RAY/XRAY    : $expxray${NC}"
echo -e  " ${purple}CLIENT NAME                 : $name${NC}"
echo -e  " ${purple}EXP SCRIPT ACCSESS          : $exp${NC}"
echo -e  " ${purple}CONTACT TELEGRAM            : @GHReyz" 
echo -e  " "
echo -e  " ${red}═════════════════════════════════════════════════════════════════ "
echo -e  "                          • MAIN MENU • "                                       
echo -e  " ${red}═════════════════════════════════════════════════════════════════ "
echo -e  " ${purple}[  1 ] SSH & OPENVPN" 
echo -e  " ${purple}[  2 ] WIREGUARD" 
echo -e  " ${purple}[  3 ] SHADOWSOCKS R" 
echo -e  " ${purple}[  4 ] SHADOWSOCKS OBFS"
echo -e  " ${purple}[  5 ] V2RAY CORE" 
echo -e  " ${purple}[  6 ] XRAY CORE" 
echo -e  " ${purple}[  7 ] TROJAN GFW" 
echo -e  " " 
echo -e  " ${red}═════════════════════════════════════════════════════════════════ "
echo -e  "                         • SYSTEM MENU • "       
echo -e  " ${red}═════════════════════════════════════════════════════════════════ "                           
echo -e  " ${purple}[  8 ] ADD/CHANGE DOMAIN VPS"
